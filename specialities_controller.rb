...
before_action :authenticate_user!
  ...
  def create
    ...
    respond_to do |format|
      if @speciality.save
        format.html { redirect_to specialities_path }
  ...
  def destroy
    @speciality.destroy
    respond_to do |format|
      format.html { redirect_to specialities_url, notice: 'Especialidade deletada com sucesso'}
  ...
  private
    ...
    def speciality_params
      params.require(:speciality).permit(:name,:image_url,:home_care)
    end
end
